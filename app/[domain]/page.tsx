...
import { getPostsForCompany, getCompanyData } from "@/lib/fetchers";
...
export async function generateStaticParams() {
  const allCompanies = await prisma.company.findMany({
    ...
    // feel free to remove this filter if you want to generate paths for all companies
    where: {
      subdomain: "demo",
    },
  });

  const allPaths = allCompanies
