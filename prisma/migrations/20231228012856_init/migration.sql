...
-- CreateIndex
CREATE UNIQUE INDEX "Post_slug_companyId_key" ON "Post"("slug", "companyId");
...
-- CreateIndex
CREATE INDEX "Buddy_companyId_idx" ON "Buddy"("companyId");
...
-- AddForeignKey
ALTER TABLE "Buddy" ADD CONSTRAINT "Buddy_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
